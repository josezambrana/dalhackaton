...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.mimetype'
        db.add_column('educacion_resource', 'mimetype',
                      self.gf('django.db.models.fields.CharField')(default='video/mpeg', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.mimetype'
        db.delete_column('educacion_resource', 'mimetype')
    ...
    models = {
        ...
        'educacion.resource': {
            ...
            'mimetype': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'published_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50'}),
