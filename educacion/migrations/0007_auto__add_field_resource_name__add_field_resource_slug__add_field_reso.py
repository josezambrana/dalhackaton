...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('educacion_resource', 'name',
                      self.gf('django.db.models.fields.CharField')(default='resource', max_length=255),
                      keep_default=False)

        # Adding field 'Resource.slug'
        db.add_column('educacion_resource', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='resource', max_length=50),
                      keep_default=False)

        # Adding field 'Resource.user'
        db.add_column('educacion_resource', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Resource.created_at'
        db.add_column('educacion_resource', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Resource.updated_at'
        db.add_column('educacion_resource', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 12, 2, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Resource.published_at'
        db.add_column('educacion_resource', 'published_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 12, 2, 0, 0), blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('educacion_resource', 'name')

        # Deleting field 'Resource.slug'
        db.delete_column('educacion_resource', 'slug')

        # Deleting field 'Resource.user'
        db.delete_column('educacion_resource', 'user_id')

        # Deleting field 'Resource.created_at'
        db.delete_column('educacion_resource', 'created_at')

        # Deleting field 'Resource.updated_at'
        db.delete_column('educacion_resource', 'updated_at')

        # Deleting field 'Resource.published_at'
        db.delete_column('educacion_resource', 'published_at')
